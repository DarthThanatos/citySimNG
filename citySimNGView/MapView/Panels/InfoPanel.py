...
from MapView.Consts import BUILDINGS_PANEL_TEXTURE, GREEN, DELETE_BUILDING_HEIGHT, DELETE_BUILDING_WIDTH, SPACE, RED
...
class InfoPanel(Panel):
    ...
    def __init__(self, pos_x, pos_y, width, height, surface, del_building_fun, stop_production_fun):
        ...
        self.del_building_button = Button(self.pos_x + self.width - DELETE_BUILDING_WIDTH * self.width, self.pos_y,
                                          DELETE_BUILDING_WIDTH * self.width, DELETE_BUILDING_HEIGHT * self.height,
        ...
        self.stop_production_button = Button(self.pos_x + self.width - DELETE_BUILDING_WIDTH * self.width,
                                             self.pos_y + self.height * DELETE_BUILDING_HEIGHT + SPACE,
                                             DELETE_BUILDING_WIDTH * self.width, DELETE_BUILDING_HEIGHT * self.height,
